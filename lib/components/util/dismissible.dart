...
class NFDismissible extends StatefulWidget {
  ...
  /// Called when the widget position is changed in some way.
  ///
  /// The [progress] is the double value in rage from 0 to 1.
  final DismissProgressCallback onDismissProgress;

  /// Called when the dismissible moves forward to be dismissed.
  final DismissDirectionCallback onForward;

  /// Whether user can "catch" the dismissible in forward move animation and reverse it back.
  ...
  @override
  _NFDismissibleState createState() => _NFDismissibleState();
}
...
class _NFDismissibleState extends State<NFDismissible>
  ...
  void initState() {
    ...
    _moveController =
        AnimationController(duration: widget.movementDuration, vsync: this)
          ...
          ..addListener(() {
            if (widget.onDismissProgress != null) {
  ...
  Future<void> _handleDragEnd(DragEndDetails details) async {
    ...
    switch (_describeFlingGesture(details.velocity)) {
      case _FlingGestureKind.forward:
        ...
        if (widget.onForward != null) widget.onForward(_dismissDirection);
