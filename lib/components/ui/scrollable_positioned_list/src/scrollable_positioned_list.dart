...
class ItemScrollController {
  ...
  /// Returns or front or back scroll controller.
  ScrollController get scrollController =>
      _scrollableListState?.scrollController ?? ScrollController();

  int get itemCount => _scrollableListState.widget.itemCount;

  ItemPositionsNotifier get itemPositionsNotifier =>
      _scrollableListState.itemPositionsNotifier;
...
class _ScrollablePositionedListState extends State<ScrollablePositionedList>
  ...
  void initState() {
    ...
    frontScrollController = ScrollController();
  ...
  Animatable<double> _opacityAnimation(_ListDisplay startListDisplay) {
    ...
    return TweenSequence<double>(<TweenSequenceItem<double>>[
      TweenSequenceItem<double>(
          tween: ConstantTween<double>(startOpacity), weight: 30),
      TweenSequenceItem<double>(
          tween: Tween<double>(begin: startOpacity, end: endOpacity),
          weight: 20),
      TweenSequenceItem<double>(
          tween: ConstantTween<double>(endOpacity), weight: 50),
    ]);
  }
  ...
  void _updatePositions() {
    widget.itemPositionNotifier?.itemPositions?.value = itemPositionsNotifier
        .itemPositions.value
