      ...
      children: [
        Tile(
          ...
          onTap: () => Navigator.of(context).push(
            ExpandUpRouteTransition(child: child, transitionSettings: transitionSettings)
          ),
        ),
        Tile(
          name: 'fade_in_transition',
          onTap: () => Navigator.of(context).push(
            FadeInRouteTransition(child: child, transitionSettings: transitionSettings)
          ),
        ),
        Tile(
        ...
        Tile(
          ...
          onTap: () => Navigator.of(context).push(
            ZoomRouteTransition(child: child, transitionSettings: transitionSettings)
          ),
        ),
      ],
    );
