    ...
    return Screen(
      ...
      children: [
        Tile(
          ...
          onTap: () => Navigator.of(context).push(ExpandUpRouteTransition(
            child: child,
        ...
        Tile(
          ...
          onTap: () => Navigator.of(context).push(FadeInRouteTransition(
            child: child,
            transitionSettings: transitionSettings,
          )),
        ),
        Tile(
          ...
          onTap: () => Navigator.of(context).push(StackFadeRouteTransition(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(),
                body: const Center(
                  child: Text('dismiss me by swiping to right!'),
                )),
          )),
        ),
        Tile(
          name: 'zoom_transition',
          onTap: () => Navigator.of(context).push(ZoomRouteTransition(
            child: child,
            transitionSettings: transitionSettings,
          )),
        ),
